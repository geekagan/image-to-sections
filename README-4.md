...
* [功能介绍](https://www.doubao.cn)

* [安装](https://www.doubao.cn)

* [使用方式](https://www.doubao.cn)

* [API 详细说明](https://www.doubao.cn)

* [使用示例](https://www.doubao.cn)

* [浏览器兼容](https://www.doubao.cn)
...
Made with ❤️ \| 如需反馈或贡献代码，请访问 [GitHub 仓库](https://github.com/your-github-username/image-to-sections)（替换 your\-github\-username 为你的GitHub用户名即可）
   

npm 发布提示：确保 package\.json 中配置正确的 main 入口文件，本包支持 ES6 模块化引入，无需额外配置。
